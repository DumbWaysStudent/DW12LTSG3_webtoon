...
export default class Home extends React.Component{
    ...
    componentDidMount = async() =>{
        ...
        await axios({
            method: 'get',
            url: 'http://192.168.0.49:4000/api/v1/webtoons?is_favorite=true'
        })
        .then(result=>{
            this.setState({dataFavorite:result.data})
        })
    }
    buttonFavorite = async(e)=>{
        ...
        if(User){
            ...
            await axios({
                method: 'PATCH',
                url: `http://192.168.0.49:4000/api/v1/favorite?id=${Iduser}&webtoon=${e}`,
                headers: {
                    Authorization: Token
                }
            })
                                    ...
                                    <CardItem>
                                        <Left style={style.leftall}>
                                            ...
                                            <Right style={style.rightall}>
                                                ...
                                                <Button 
                                                    small 
                                                    style={style.buttonListAll}
                                                    onPress={()=> this.buttonFavorite(item.id)}
                                                >
